...
" tag names
syn keyword htmlTagName contained aside address applet area a base basefont
...
syn keyword htmlTagName contained footer form hr html img
syn keyword htmlTagName contained input isindex kbd li link map menu
syn keyword htmlTagName contained meta ol option param pre p samp span
syn keyword htmlTagName contained select section small strike sub sup
