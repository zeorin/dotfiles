...
in ({ lib, stdenv, writeShellScriptBin, fetchFromGitHub, runCommandLocal, tabfs
  , fuse, web-ext, pass, nativeMessenger ? "za.co.xandor.tabfs"
  ...
  in stdenv.mkDerivation {
    ...
    passthru = {
      inherit version pname nativeMessenger addonId;
      sign-unlisted-extension =
        writeShellScriptBin "tabfs-sign-unlisted-extension" ''
          set -euo pipefail
