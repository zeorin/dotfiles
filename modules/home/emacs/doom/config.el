...
(setq org-directory (concat (xdg-user-dir "documents") "/notes/")
...
(use-package! spell-fu
  :config
  (setq ispell-personal-dictionary (concat (or (getenv "$DOOMLOCALDIR")
					       "~/.local/share/doomemacs") "/etc/spell-fu/.pws")
  ...
  (setq lsp-eslint-server-command '("node" "@eslintServer@" "--stdio"))
  ...
  (use-package! dap-mode
    ...
    (setq ;; dap-auto-configure-features '(sessions locals breakpoints expressions tooltip)
     dap-firefox-debug-path "@firefox-debug-path@"
     dap-firefox-debug-program `("node" ,(concat dap-firefox-debug-path "/dist/adapter.bundle.js"))
     dap-js-path "@js-debug-path@"
  ...
  (setq dash-docs-docsets-path (concat (xdg-data-home) "/docsets")
